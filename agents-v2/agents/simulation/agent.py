...
class SimulationAgent:
    """
    SimulationAgent using Google ADK Agent.
    Simulates failure propagation in supply-chain dependency graphs.
    """
    ...
    def _load_prompt(self) -> str:
        ...
        try:
            ...
            return """You are the SimulationAgent for Guardian AI. Enumerate all possible propagation paths from a starting vendor/component failure through the dependency graph using deterministic graph traversal."""
